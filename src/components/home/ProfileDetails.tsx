...
import { TabsContent, TabsList, TabsTrigger } from "@ui/tab";
	...
	return (
		<TabsContent value="profile" className="bottom-6  h-full">
			<div className="grid grid-rows-layout  grid-cols-layout gap-6 h-full">
				...
				<section className="bg-white h-full w-full rounded-md grid grid-rows-[.25fr_minmax(0,_1fr)_94px] gap-10 ">
					<div className="flex flex-col w-full px-10 pt-10">
						<h1 className="text-heading-m">Profile Details</h1>
						<p className="text-body-m text-grey">Add your details to create a personal touch to your profile.</p>
					</div>

					<div className="px-10 flex flex-col items-center gap-6">
						<div className="bg-grey-light rounded-md p-5 flex items-center justify-between w-full">
							<p className="w-full text-body-m text-grey">Profile picture</p>
							<div className="w-full">
								<DropZone setFiles={setFiles} files={files} />
							</div>

							<p className="w-full text-body-s text-grey">
								Image must be below 1024x1024px.
								<br /> Use PNG or JPG format.
							</p>
						</div>

						<div className="bg-grey-light rounded-md p-5 w-full flex flex-col gap-3">
							<div className="columns-2">
								<p className="w-full text-body-m text-grey">First Name*</p>
								<TextField placeholder="e.g. John" id="name" name="name" />
							</div>
							<div className="columns-2">
								<p className="w-full text-body-m text-grey">Last Name*</p>
								<TextField placeholder="e.g. Appleseed" id="last" name="last" />
							</div>

							<div className="columns-2">
								<p className="w-full text-body-m text-grey">Email</p>
								<TextField placeholder="e.g. email@example.com" id="email" name="email" />
							</div>
						</div>
					</div>
